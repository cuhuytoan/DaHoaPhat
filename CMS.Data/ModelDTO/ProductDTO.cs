...
namespace CMS.Data.ModelDTO
{
    ...
    {
        List<ProductPropertiesCategoryDTO> lstProductPropertiesCategory { get; set; } = new();
        List<ProductPropertyValue> lstProductPropertyValue { get; set; } = new();
    }
    public class ProductPropertiesCategoryDTO : ProductPropertyCategory
    {
        public List<ProductProperty> lstProductProperties { get; set; } = new();
    }    
}
